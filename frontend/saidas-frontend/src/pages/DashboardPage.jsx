...
export default function DashboardPage() {
  ...
  const problemLabel = PROBLEM_LABELS[summary?.problem_type] || summary?.problem_type;
    ...
    <div className="flex min-h-screen bg-surface">
      ...
      <aside className="hidden lg:flex flex-col w-56 shrink-0 sticky top-0 h-screen
        ...
        {uploadResult?.filename && (
          <div className="mx-4 mb-4 px-3 py-2 rounded-lg bg-surface
            ...
            <p className="text-[10px] text-text-muted">
              {summary?.rows?.toLocaleString()} rows · {summary?.feature_count} features
            </p>
          </div>
        )}

        {/* Problem type badge */}
        <div className="mx-4 mb-5 px-3 py-1.5 rounded-lg text-center text-xs font-semibold
                        bg-primary/10
                        text-primary
      ...
      <main className="flex-1 min-w-0 py-8 px-4 sm:px-6 lg:px-8 space-y-8">
          ...
          {models?.comparison?.best_model && (
            <div className="flex items-center gap-2 px-4 py-2 rounded-xl
              ...
              <div className="text-sm">
                <p className="text-[10px] label text-success">Best Model</p>
        ...
        {/* ── A: Summary Cards ─────────────────────────────────────────── */}
        <section id="section-summary" className="scroll-mt-6 animate-[slideUp_0.30s_ease]">
        ...
        <section id="section-correlation" className="scroll-mt-6 animate-[slideUp_0.33s_ease]">
        ...
        <div className="grid grid-cols-1 xl:grid-cols-2 gap-6">
          <section id="section-pca" className="scroll-mt-6 animate-[slideUp_0.36s_ease]">
          ...
          <section id="section-clusters" className="scroll-mt-6 animate-[slideUp_0.36s_ease]">
        ...
        {/* ── D: Model Performance ─────────────────────────────────────── */}
        <section id="section-models" className="scroll-mt-6 animate-[slideUp_0.39s_ease]">
        ...
        <section id="section-features" className="scroll-mt-6 animate-[slideUp_0.42s_ease]">
        ...
        {/* ── F: Association Rules ─────────────────────────────────────── */}  {/* NEW */}
        <section id="section-association" className="scroll-mt-6 animate-[slideUp_0.45s_ease]">
        ...
        {/* ── G: Outlier Detection ─────────────────────────────────────── */}  {/* NEW */}
        <section id="section-outliers" className="scroll-mt-6 animate-[slideUp_0.48s_ease]">
        ...
        {/* ── H: Insights ──────────────────────────────────────────────── */}
        <section id="section-insights" className="scroll-mt-6 animate-[slideUp_0.51s_ease]">
